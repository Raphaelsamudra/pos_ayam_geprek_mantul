  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Piutang <b>Belum Lunas</b></h1>
          </div>
          <div class="col-sm-6">
...
<script>
    $(document).ready(function(){
        var table = $('#example1').DataTable( { 
             "processing": true,
             "serverSide": true,
             "ajax": "piutang-data.php?cabang=<?= $sessionCabang; ?>",
             "columnDefs": 
             [
              {
                "targets": 5,
        ...
        $('#example1 tbody').on( 'click', '.tblEdit', function () {
            ...
            if ( link === true ) {
                window.location.href = "piutang-edit?no="+ data0;
            }
        });
        ...
        $('#example1 tbody').on( 'click', '.tblPrint', function () {
            var data = table.row( $(this).parents('tr')).data();
            var data0 = data[0];
            window.open('nota-cetak-piutang?no='+ data0, '_blank');
        });
        ...
        $('#example1 tbody').on( 'click', '.tblDelete', function () {
            ...
            if ( link === true ) {
                window.location.href = "penjualan-delete-invoice?id="+ data0 + "&page=piutang";
            }
        });
