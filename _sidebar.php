<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #8b1209;">
    <!-- Brand Logo -->
    <a href="bo" class="brand-link" style=" border-bottom: 1px solid white;"> <!-- Menambahkan border putih -->
      <img src="dist/img/gm-logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
      <span class="brand-text font-weight-light">POS - GM PROJECT</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
      <!-- Sidebar user panel (optional) -->
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-bottom: 1px solid white;"> <!-- Garis putih di bawah panel user -->
        <div class="image">
          <img src="dist/img/logo-user1.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!-- <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <?php if ( $levelLogin !== "admin" && $levelLogin !== "admin" ) { ?>
              <!--<li class="nav-item">
